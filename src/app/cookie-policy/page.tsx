...
import LegalBackHeader from "@/components/layout/LegalBackHeader";

export const metadata: Metadata = {
  title: "Cookie Policy",
  description:
    "Cookie Notice for QUANT EDGE DATA SOLUTIONS LIMITED explaining how cookies are used and how to manage preferences.",
};
      ...
      <article className="legal-shell">
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            security, network management, and session continuity. You cannot opt out of these if
          ...
          <p>
            ...
            use this website (for example page views and traffic sources). These
            analytics cookies are loaded only after you choose{" "}
            <strong>Accept all cookies</strong>, or enable Analytics in{" "}
            <strong>Manage cookies</strong> and save your preferences. If you
            reject non-essential cookies or leave Analytics off, Google Analytics
            is not loaded.
          </p>
          <p>
            We do not currently use separate advertising cookies. If that changes,
            we will update this notice and ask for consent where required.
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            website functionality. You can also reopen this site&apos;s cookie banner anytime via{" "}
